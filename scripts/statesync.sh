...
# Initialize chain.
blackd init test --chain-id black_9000-2

# Get Genesis
wget https://archive.black.org/mainnet/genesis.json
mv genesis.json ~/.blackd/config/

wget -O ~/.blackd/config/adrbook.json https://snapshot.notional.ventures/black/addrbook.json
