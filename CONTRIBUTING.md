...
Gridiron uses [Tendermint’s coding repo](https://github.com/tendermint/coding)
...
1. Either [open](https://github.com/fury-labs/blackfury/issues/new/choose)
   or [find](https://github.com/fury-labs/blackfury/issues) an issue you have identified and would like to contribute to
   resolving.
...
3. If you would like to contribute:
    ...
    8. Please make sure to run `make format` before every commit -
       ...
       There are CI tests built into the Gridiron repository
...
Check out our [good first issues](https://github.com/fury-labs/blackfury/issues?q=label%3A%22good+first+issue%22).

## <span id="adr">Architecture Decision Records (ADR)</span>

When proposing an architecture decision for Gridiron,
please create an [ADR](https://github.com/fury-labs/blackfury/blob/main/docs/architecture/README.md)
...
While my fork lives at `https://github.com/fury-labs/blackfury`,
the code should never exist at `$GOPATH/src/github.com/fury-labs/blackfury`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,`$GOPATH/src/github.com/fury-labs/blackfury`,
...
2. Go to the original repo checked out locally. (i.e. `$GOPATH/src/github.com/fury-labs/blackfury`)
...
4. Create your feature branch from `development` either on `github.com/fury-labs/blackfury`, or your fork (
...
**Note**: tharsis’s Gridiron team currently cuts releases on a need to have basis.
