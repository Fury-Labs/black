...
1. Either [open](https://github.com/fury-labs/black/issues/new/choose)
   or [find](https://github.com/fury-labs/black/issues) an issue you have identified and would like to contribute to
   resolving.
...
Check out our [good first issues](https://github.com/fury-labs/black/issues?q=label%3A%22good+first+issue%22).

## <span id="adr">Architecture Decision Records (ADR)</span>

When proposing an architecture decision for Black,
please create an [ADR](https://github.com/fury-labs/black/blob/main/docs/architecture/README.md)
...
While my fork lives at `https://github.com/fury-labs/black`,
the code should never exist at `$GOPATH/src/github.com/fury-labs/black`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,`$GOPATH/src/github.com/fury-labs/black`,
...
2. Go to the original repo checked out locally. (i.e. `$GOPATH/src/github.com/fury-labs/black`)
...
4. Create your feature branch from `development` either on `github.com/fury-labs/black`, or your fork (
