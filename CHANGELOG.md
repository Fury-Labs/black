...
- (contracts) [#1306](https://github.com/evmos/evmos/pull/1306) Migrate `contracts` directory to black repository
...
- (tests) [#1434](https://github.com/evmos/evmos/pull/1434) Set default staking denom to `afury` in `evm` and `feemarket` tests
...
- (deps) [#1370](https://github.com/evmos/evmos/pull/1370) Bump Cosmos SDK version to [`v0.46.9-ledger`](https://github.com/black/cosmos-sdk/releases/tag/v0.46.9-ledger)
...
- (evm) [#1349](https://github.com/evmos/evmos/pull/1349) Restrict the Black codebase from working with chain IDs other than `9000` and `9001`
...
- (deps) [#1473](https://github.com/evmos/evmos/pull/1473) Bump Cosmos SDK version to [v0.46.10-alpha.ledger.2](https://github.com/black/cosmos-sdk/releases/tag/v0.46.10-alpha.ledger.2)
...
- (deps) [#1498](https://github.com/evmos/evmos/pull/1498) Bump Cosmos SDK version to [v0.46.10-ledger.1](https://github.com/black/cosmos-sdk/releases/tag/v0.46.10-ledger.1)
...
- (deps) [#1288](https://github.com/evmos/evmos/pull/1288) Bump `ethermint` to [`v0.21.0`](https://github.com/black/ethermint/releases/v0.21.0)
...
- (deps) [#1279](https://github.com/evmos/evmos/pull/1279) Bump Cosmos SDK version to [`v0.46.8-ledger`](https://github.com/black/cosmos-sdk/releases/tag/v0.46.8-ledger)
...
- (deps) [#1184](https://github.com/evmos/evmos/pull/1184) Bump Ethermint version to [`v0.20.0-rc5`](https://github.com/black/ethermint/releases/tag/v0.20.0-rc5)
...
- (cmd) [\#1121](https://github.com/evmos/evmos/pull/1121) Fix `black version` to show either tag or last commit.
...
- (deps) [\#845](https://github.com/evmos/evmos/pull/845) Bump Ethermint version to [`v0.19.0`](https://github.com/black/ethermint/releases/tag/v0.19.0)
...
- (deps) [\#803](https://github.com/evmos/evmos/pull/803) Bump Ethermint version to [`v0.17.2`](https://github.com/black/ethermint/releases/tag/v0.17.2)

## [v6.0.2] - 2022-07-13

### Bug Fixes

- (deps) [\#769](https://github.com/evmos/evmos/pull/769) Bump Ethermint version to [`v0.17.1`](https://github.com/black/ethermint/releases/tag/v0.17.1)
...
- (deps) [\#719](https://github.com/evmos/evmos/pull/719) Bump Ethermint version to [`v0.17.0`](https://github.com/black/ethermint/releases/tag/v0.17.0)
...
- (deps) [\#663](https://github.com/evmos/evmos/pull/663) Bump Ethermint version to [`v0.16.1`](https://github.com/black/ethermint/releases/tag/v0.16.1)
...
- (analytics) [\#637](https://github.com/evmos/evmos/pull/637) Add telemetry to Black modules.
...
- (upgrade) [\#557](https://github.com/evmos/evmos/pull/557) Update Black go.mod version `v3` -> `v4`
...
- (inflation) [\#536](https://github.com/evmos/evmos/pull/536) Rename inflation endpoint `/black/inflation/v1/total_supply` -> `/black/inflation/v1/circulating_supply`

### Improvements

- (deps) [\#580](https://github.com/evmos/evmos/pull/580) Bump Ethermint to [`v0.15.0`](https://github.com/black/ethermint/releases/tag/v0.15.0)
...
- (cmd) [\#543](https://github.com/evmos/evmos/pull/543) Update mainnet default `min-gas-price` to `0.0025afury`.
...
- [\#415](https://github.com/evmos/evmos/pull/415) Bump Black go version to v3
...
- (deps) [\#478](https://github.com/evmos/evmos/pull/478) Bump Ethermint to [`v0.14.0`](https://github.com/black/ethermint/releases/tag/v0.14.0)
- (vesting) [\#468](https://github.com/evmos/evmos/pull/468) Use coins `Min` function from Cosmos SDK.
- (cmd) [\#446](https://github.com/evmos/evmos/pull/446) Update `migrate` command to migrate Black, Ethermint and Cosmos SDK modules.
...
- (deps) [\#360](https://github.com/evmos/evmos/pull/360) Bump Ethermint to [`v0.11.0`](https://github.com/black/ethermint/releases/tag/v0.11.0)
...
- (deps) [\#345](https://github.com/evmos/evmos/pull/345) Bump Ethermint to [`v0.10.2`](https://github.com/black/ethermint/releases/tag/v0.10.2)
...
- (deps) [\#135](https://github.com/evmos/evmos/pull/135) Bump Ethermint version to [`v0.9.0`](https://github.com/black/ethermint/releases/tag/v0.9.0)
- (ci) [\#136](https://github.com/evmos/evmos/pull/136) Deploy `black` docker container to [docker hub](https://hub.docker.com/u/tharsishq) for every versioned releases
...
- (deps) [\#110](https://github.com/evmos/evmos/pull/110) Bump Ethermint version to [`v0.8.1`](https://github.com/black/ethermint/releases/tag/v0.8.1)
...
- (deps) [\#94](https://github.com/evmos/evmos/pull/94) Bump Ethermint version to [`v0.8.0`](https://github.com/black/ethermint/releases/tag/v0.8.0)
