...
Please refer to the official Gridiron [bug bounty program](https://immunefi.com/bounty/blackfury/)
...
- Use the Gridiron [bug bounty program](https://immunefi.com/bounty/blackfury/) on Immunefi to disclose all vulnerabilities,
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Gridiron in a
    ...
    5. A week (or less) after the security vulnerability has been patched on Gridiron,
...
including but not limited to Gridiron,
...
The Gridiron Security Team is constantly being monitored.
