...
## 3. Clone this ~/.black home directory into some others, let's say `~/.clonedlack`
## 4. Run `gentx` in each of those folders
## 5. Copy the `gentx-*` folders under `~/.clonedlack/config/gentx/` folders into the original `~/.black/config/gentx`
